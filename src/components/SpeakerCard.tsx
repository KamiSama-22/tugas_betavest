        ...
        <div className="cursor-pointer flex flex-col items-center gap-4 group">
            <div className="relative h-1/3 z-1">
                <img
                    src={imageUrl}
                    alt={name}
                    className="h-50 w-50 rounded-full border-10 border-red-900 mx-auto group-hover:scale-105 transition-transform duration-300 object-cover"
                />
            </div>
            <div className="cursor-pointer flex flex-col items-center h-3/4 border-4 border-red-900 w-full p-4 rounded-lg relative py-10 shadow-xl shadow-black/20 group-hover:shadow-2xl group-hover:shadow-black/40 transition-all duration-300">
        //card overlay
